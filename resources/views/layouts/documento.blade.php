        ...
        <div class="card-header border-bottom-dashed p-4">
            <div class="d-sm-flex">
                ...
                <div class="flex-shrink-0 mt-sm-0 mt-3" style="text-align: right">
                    <h6><span class="text-muted fw-normal">Direcci&oacute;n: &nbsp;</span> <span
                            id="legal-register-no">San Fernando de Apure </span></h6>
                    <h6><span class="text-muted fw-normal">Email: &nbsp;</span> <span
                            id="email">email@grupoabdul.com</span></h6>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body p-4">
            <div class="row g-3">
                <div class="col-lg-3 col-6">
                    ...
                    <h5 class="fs-15 mb-0"> <span id="invoice-no"> {{$numerod}}</span></h5>
                </div>

                <div class="col-lg-3 col-6">
                    <p class="text-muted mb-2 text-uppercase fw-semibold fs-14">FECHA</p>
                    <h5 class="fs-15 mb-0"><span id="invoice-date">{{$documento->fecha}}</span> <small
                            class="text-muted" id="invoice-time">{{$documento->hora}}</small></h5>
                </div>
                <div class="col-lg-3 col-6">
