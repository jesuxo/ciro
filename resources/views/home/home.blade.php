...
@section('css')
    <style>
        @media (max-width: 768px) {
            .ecommerce-home {
                /* Fuerza que el contenedor tenga el ancho completo de la pantalla */
                width: 100vw !important; /* 100% del ancho de la ventana */
                margin-left: calc(-50vw + 50%) !important;; /* Centra y corrige posibles desbordes */

                /* Ajustes para la imagen de fondo */
                background-size: cover !important;; /* La imagen cubrirá todo el contenedor */
                background-position: center !important;; /* Centra la imagen */
                background-repeat: no-repeat !important;;

                /* Altura: puedes ajustarla según necesites */
                min-height: 300px !important;; /* Altura mínima para móvil */
            }
        }
...
@section('content')
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="ecommerce-home bg-danger-subtle"
                         style="background-image: url('{{ URL::asset('build/images/ecommerce/home/img-11.png')}}');">
                        <div class="container">
                            <div class="row justify-content-end" style="display: none">
                                <div class="col-lg-7">
                                    <div class="text-sm-end">
                                        <p class="fs-15 fw-semibold text-uppercase text-white"><i
                                                class="ri-flashlight-fill text-primary align-bottom me-1"></i>Concurso Activo</p>
                                        <h1 class="display-4 fw-bold lh-base text-capitalize mb-3" style="color: antiquewhite !important;">
                                            GÁNATE UN VIAJE A LA PLAYA ✨</h1>
                                        <p class="fs-20 mb-4">¿Cómo participar?</p>
                                        <a href="https://www.instagram.com/reel/DNEkw1mv6kx/?igsh=cHlwemY4b3JhODdx" class="btn btn-danger btn-hover"><i
                                                class="bi bi-instagram"></i> Sigue los pasos</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div id="app-chat-container" class="pusher-container pusher-mobile   "  >
        <div id="app-bot-bot" data-fromtype="bot" data-fromid="bot" data-idconversation="null" data-id-question="1" data-id-flow="null" data-id-categ="null" data-id-sector="null" class="app-chat-container-top">
            <div class="chat-launcher app-chat-launcher"  style="display: block;">
                ...
                <div class="chat-launcher-preview " style="display: none">
                    <!--firstmessage-->
                    <div class="app-conversation-summary ">
                        Hola!! Si deseas algun tipo de informaci&oacute;n puedes escribirnos al
                        <a href="https://api.whatsapp.com/send/?phone=584247105601&text=Hola+Srs.+de+CIRO+quisiera+obtener+informacion+de+sobre:+&type=phone_number&app_absent=0">+58 424-7105601</a>
