...
@section('og-section')
    @if(isset($data->id))
        <meta property="og:title" content='{{str_replace("'", '', $data->public_title)}}' />
        <meta property="og:type"  content="website" />
        <meta property="og:url"   content="{{route('ver.promo', $data->id)}}">
        @if(isset($data->imagen))
            <meta property="og:image" content="{{asset('img/promocion/ogc'.$data->imagen)}}" />
        @else
            <meta property="og:image" content="{{asset('img/default.jpg')}}" />
        @endif
        <meta property="og:description" content='{{ substr($data->public_descrip, 0, 30)}}' />
    @endif
@endsection
        ...
        @if(isset($data))
            <div class="container mt-3">
                <div class="row desktop-top">
                        ...
                        @if(isset($data->imagen) and  $data->imagen != '')
                            <div class="col-lg-6 col-lg-offset-3 mb-4"  >
                                    @php
                                    $file = ($data->imagen)? asset('img/promociones/'.$data->imagen) : '';
                                    @endphp
                                <img src="{{$file}}" style="width: 100%; cursor:pointer;" class="promomodal"   >
                            </div>
                        @endif
