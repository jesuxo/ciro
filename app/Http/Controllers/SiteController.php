...
class SiteController extends Controller
{
    ...
    public function promociones(Request $request, $busqueda = null){
        ...
        if(isset($busqueda) and $busqueda == 'SanCristobal'){
            $promociones = Promocion::where(['activo' => 1, 'pendiente' => 0])
                ->whereRaw("( tienda = 'SanCristobal' )")
                ->orderBy('combo', 'desc')
                ->orderBy('descrip', 'desc')
                ->get();
        }else{
            if(isset($busqueda) and $busqueda == 'ElVigia'){
                $promociones = Promocion::where(['activo' => 1, 'pendiente' => 0])
                    ->whereRaw("( tienda = 'ElVigia' )")
                    ->orderBy('combo', 'desc')
                    ->orderBy('descrip', 'desc')
                    ->get();
            }else{
        ...
        return view('home.promociones', compact('promociones', 'paginapromo', 'gosearchpromo'));
    }
    ...
    public function promo($id)
    {
        ...
        return view('home.promocion', compact('data', 'paginapromo'));
    }
    ...
    public function index(Request $request, $id = null)
    {
        ...
        return view($view, compact('promociones', 'paginapromo', 'gosearchpromo'));
